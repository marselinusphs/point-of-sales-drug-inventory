...
?>
<!-- Kolom Faktur-->
<div class="bg-green p-2 text-white" style="border-radius:0.25rem; background: #00105b; height:50px; margin-bottom:10px;">
    <h4 class="mb-0">Pengaturan Akun</h4>
</div>

<!-- Profile widget -->
<div class="bg-white shadow rounded overflow-hidden">
    <div class="bg-green px-4 " style="border-radius:0.25rem;  background:#63aff7;">
        <div class="media align-items-end profile-header">
            ...
            <div class="media-body mb-5 text-white">
                <h3 class="mt-0 mb-0"><?php echo $username ?></h3>
